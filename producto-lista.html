...
<head>
  ...
  <title>DHShop - Productos</title>
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"
    integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  <link rel="stylesheet" href="css/header-footer.css">
  <link rel="stylesheet" href="css/producto-lista.css">
</head>
...
<body>
  ...
  <header>
    <section class="logo-usuario">
      <!-- section que tiene el logo y los botones de login-registro -->
      <article class="logo">
        <a href="index.html"><img src="img/logo-dh.PNG" alt=""></a>
      </article>
      <article class="usuario-acciones">
        <a href="registro.html" id="registrarme">Crear cuenta</a>
        <a href="ingreso.html" id="ingresar">Ingresar</a>
      </article>
    </section>
    <hr>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="producto-lista.html">Productos</a>
          </li>
          <li class="nav-item">
    ...
    <main>
      ...
      <section class="row products-list">
        ...
        <div class="product-container col-12 col-md-4 col-lg-3">
          <a href="producto-detalle.html" class="product">
  ...
  <footer>
    ...
    <section class="footer-nav">
      <ul>
        ...
        <li><a href="producto-lista.html">Productos</a></li>
